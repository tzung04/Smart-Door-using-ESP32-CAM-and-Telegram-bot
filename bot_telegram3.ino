...
const char* ssid = "DCE_803";  //WiFi Name
const char* password = "dce@soict";  //WiFi Password

// Initialize Telegram BOT
String chatId = "7218554481";
String BOTtoken = "7729804112:AAFPbQ0eKWRAfGRxfrGExdLoStEfgRcVO1M";
...
void handleNewMessages(int numNewMessages){
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    if (text == "/stream") {
      ...
      bot.sendMessage(chatId, "Live stream available at: " + streamUrl + ". \nWork when you are at home!", "");
    }
    if (text == "/start"){
      ...
      welcome += "/stream : Watch video from the door\n";
      welcome += "Tap on /message to use feature.\n";
